...
const MapLegend = ({ mapType }: Props) => {
    ...
    const gradientStops = data.stops
        ...
        .join(",")
    return (
        <div className="absolute bottom-15 md:bottom-0 left-4 z-1000 w-50 md:w-96 rounded-xl shadow p-4 bg-background/50 text-center border border-accent/70 flex flex-col gap-3">
